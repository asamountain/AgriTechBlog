...
async function main() {
  ...
  switch (command) {
    ...
    default:
      ...
      console.log('  node scripts/figma-integration-direct.js sync   - Extract design tokens once');
      console.log('  node scripts/figma-integration-direct.js init   - Initialize configuration');
  }
}
