...
2. ❌ **MongoDB SRV DNS**: `querySrv ECONNREFUSED _mongodb._tcp.cluster0.xxxxx.mongodb.net`
...
MONGODB_URI_MOBILE="mongodb://blog-admin-new:YOUR_PASSWORD_HERE@cluster0-shard-00-00.xxxxx.mongodb.net:27017,cluster0-shard-00-01.xxxxx.mongodb.net:27017,cluster0-shard-00-02.xxxxx.mongodb.net:27017/blog_database?ssl=true&replicaSet=atlas-xxxxx-shard-0&authSource=admin&retryWrites=true&w=majority"

# Regular connection (for WiFi/Ethernet)
MONGODB_URI="mongodb+srv://blog-admin-new:YOUR_PASSWORD_HERE@cluster0.xxxxx.mongodb.net/blog_database?retryWrites=true&w=majority&appName=Cluster0"
```
...
private async detectNetworkEnvironment(): Promise<'wifi' | 'mobile' | 'unknown'> {
  try {
    // Test SRV resolution
    await dns.resolveSrv('_mongodb._tcp.cluster0.xxxxx.mongodb.net');
    return 'wifi';
  } catch (error) {
...
```bash
# Test DNS resolution
nslookup _mongodb._tcp.cluster0.xxxxx.mongodb.net

# Test port connectivity
nc -v -z cluster0-shard-00-00.xxxxx.mongodb.net 27017
