...
export function ShadowLoader({ size = 'md', text }: LoadingSpinnerProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center space-y-3">
      <div className="relative">
        ...
        />
        <Loader2 className={`${sizeClasses[size]} text-gray-600 animate-spin relative z-10`} />
      </div>
      {text && (
...
export function LoadingSpinner({ size = 'md', text }: LoadingSpinnerProps) {
  return <ShadowLoader size={size} text={text} />;
}
...
export const AgricultureLoader = LoadingSpinner;
export const AgriculturePageLoader = PageLoader;
export const AgriculturalSkeleton = ContentSkeleton;